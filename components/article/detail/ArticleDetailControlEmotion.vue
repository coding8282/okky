  ...
  <div class="mt-5">
    <section>
      ...
      <div class="d-inline mr-2">
        <a @click.prevent="onDoEmotion('LIKE')" class="btn btn-sm m-0 p-0">
      ...
      <!-- 재밌어요 -->
      <div class="d-inline mr-2">
        <a @click.prevent="onDoEmotion('FUN')" class="btn btn-sm m-0 p-0">
      ...
      <!-- 고마워요 -->
      <div class="d-inline mr-2">
        <a @click.prevent="onDoEmotion('THANKS')" class="btn btn-sm m-0 p-0">
      ...
      <!-- 슬퍼요 -->
      <div class="d-inline mr-2">
        <a @click.prevent="onDoEmotion('SAD')" class="btn btn-sm m-0 p-0">
      ...
      <!-- 화나요 -->
      <div class="d-inline mr-2">
        <a @click.prevent="onDoEmotion('ANGRY')" class="btn btn-sm m-0 p-0">
